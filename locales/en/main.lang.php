...
L10n::$locales['Scrollbar width (in pixels):'] = '';
L10n::$locales['Scrollbar color (light mode):'] = '';
L10n::$locales['Scrollbar color (dark mode):'] = '';
L10n::$locales['Add shadow to the scrollbar'] = '';
L10n::$locales['Activate only in single entry context'] = '';
